...
# SoC ess-mode underlay (thicker translucent line behind SoC)
_HSL_ESS_UNDERLAY_HOLD = (190.0, 80.0, 45.0)
_HSL_ESS_UNDERLAY_CHARGE = (220.0, 85.0, 45.0)
_HSL_ESS_UNDERLAY_DISCHARGE = (348.0, 83.0, 45.0)
COLOR_ESS_UNDERLAY_HOLD = color_from_hsl(*_HSL_ESS_UNDERLAY_HOLD)
COLOR_ESS_UNDERLAY_CHARGE = color_from_hsl(*_HSL_ESS_UNDERLAY_CHARGE)
COLOR_ESS_UNDERLAY_DISCHARGE = color_from_hsl(*_HSL_ESS_UNDERLAY_DISCHARGE)
