...
| `EARNIE_UI_MODES`                       | Kommagetrennt: `sunset2sunset` (Betrieb: Monitor + Manuelle Geräte), `scenario_explorer`, `price_forecast` (Prod: `sunset2sunset,scenario_explorer`; Cloud nur Explorer: `scenario_explorer`; siehe [Betriebsmodi](../ui/betriebsmodi.md)). Legacy-Alias: `ENERGY_OPTIMIZER_UI_MODES`. |
