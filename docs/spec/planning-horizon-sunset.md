...
Standard für SE ist `sunrise_window` (Sunset-2-Sunset / Live-aligned); `fixed_24h` bleibt als Vergleichsmodus wählbar.

### 4.1 Modus `fixed_24h` (Vergleich / bisheriges Verhalten)
