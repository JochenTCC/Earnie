...
`EARNIE_UI_MODES=sunset2sunset,scenario_explorer,live_environment` (Prod; Legacy-Alias `ENERGY_OPTIMIZER_UI_MODES`). Kein Alias `live`, `backtesting` oder `scenario_exploration`.
