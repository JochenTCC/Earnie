...
**German how-to (operators):** [`docs/einrichtung/loxone-earnie-library.md`](../../../docs/einrichtung/loxone-earnie-library.md) — copy into Config, Earnie URL, EFM, Earnie-dead fallback, Greenfield import.
...
- **Earnie-dead fallback** — watchdog on `Earnie_Heartbeat` age in Config: [loxone-earnie-library.md](../../../docs/einrichtung/loxone-earnie-library.md#5-earnie-tot-fallback-in-loxone-config).
