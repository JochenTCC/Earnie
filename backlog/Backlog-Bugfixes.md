...
- [ ] **Streamlit UI HTTP 500 on NAS/Docker (`GZipResponder` / `thread_minimum_size`)** — pin `starlette>=0.46.0,<1.4` in `pyproject.toml`; retag/overwrite pre-release `v2.4.0-alpha.5` (image rebuild).
