#!/usr/bin/env python3
"""Extrahiert tests/fixtures/backtesting/cons_data.csv aus runtime/cons_data.csv."""
...
DEFAULT_TARGET = REPO_ROOT / "tests" / "fixtures" / "backtesting" / "cons_data.csv"
...
def extract(source: Path, target: Path) -> int:
    if not source.is_file():
        raise FileNotFoundError(
            ...
            "Bitte runtime/cons_data.csv bereitstellen."
        )
